								...
								<div class="row view-default">
									...
									<div class="col-md-4 col-xl-4">
										<div class="card user-card">
											<div class="card-header"><h5>Remaining Leave Request Days</h5></div>
											<div class="card-body remaining_days"></div>
										</div>
									</div>
									<!-- [ basic-table ] end -->
									<hr>
											...
											<div class="card-body">
												...
												<div class="justify-content-center d-flex">
													<div class="col-md-8">
														...
														<div class="leave-info">
															<span class="f-w-600 leave-name">Status:</span>
															<span class="leave-days" id="status"></span>
														</div>
													</div>
												</div>
												<hr>
