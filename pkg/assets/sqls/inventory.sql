...
CREATE TABLE inv_warehouses (
	...
	CONSTRAINT fk_wh_province FOREIGN KEY (prov_id) REFERENCES ref_provinces(prov_id),
	CONSTRAINT fk_wh_city FOREIGN KEY (city_id) REFERENCES ref_cities(city_id),
	CONSTRAINT fk_wh_barangay FOREIGN KEY (brgy_id) REFERENCES ref_barangays(brgy_id)
);
...
-- START HERE FOR PLUGGIN ING INJECTION  
