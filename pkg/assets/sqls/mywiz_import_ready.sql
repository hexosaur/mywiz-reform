...
ON DUPLICATE KEY UPDATE
    ...
    department_scope = VALUES(department_scope);

-- THIS TABLE IS FOR ACCESS LEVELS
...
ON DUPLICATE KEY UPDATE
    ...
    permission_class = VALUES(permission_class),
...
VALUES ('Super Admin', NULL, 'Default', NULL, 'administrator', '$2y$10$VUI1/nifFIufPzm93O15bOOCifv/AhepkjZs64iSSS/OgP5oOLZHy', 1)
ON DUPLICATE KEY UPDATE
...
CREATE TABLE IF NOT EXISTS auth_remember_tokens (
    ...
    KEY idx_tokens_user (user_id, user_type),
...
CREATE TABLE IF NOT EXISTS leave_requests (
    ...
    KEY idx_lr_proxy (proxy_employee_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS leave_request_steps (
    ...
    KEY idx_steps_req (request_id, step_no),
...
-- mgmt_role_permissions foreign keys
...
-- leave_request_steps foreign keys
