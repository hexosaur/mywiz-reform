									...
									<div class="card prod-p-card bg-c-yellow">
										<div class="card-body">
											<div class="row align-items-center m-b-25">
												<div class="col">
													<h6 class="m-b-5 text-white">Pending Projects</h6>
													<h3 class="m-b-0 text-white">3</h3>
												</div>
												<div class="col-auto">
								...
								<div class="col-xl-3 col-md-6">
									<div class="card prod-p-card bg-c-blue">
										<div class="card-body">
											<div class="row align-items-center m-b-25">
												<div class="col">
													<h6 class="m-b-5 text-white">Ongoing Projects</h6>
													<h3 class="m-b-0 text-white">3</h3>
												</div>
												<div class="col-auto">
													<i class="fas fa-hammer text-c-blue f-18"></i>
												</div>
											</div>
									...
									<div class="card prod-p-card bg-c-red">
										<div class="card-body">
											<div class="row align-items-center m-b-25">
												<div class="col">
													<h6 class="m-b-5 text-white">Cancelled Projects</h6>
													<h3 class="m-b-0 text-white">2</h3>
												</div>
												<div class="col-auto">
													<i class="fas fa-ban text-c-red f-18"></i>
												</div>
											</div>
								...
								<div class="col-xl-3 col-md-6">
									<div class="card prod-p-card bg-c-green">
										<div class="card-body">
											<div class="row align-items-center m-b-25">
												<div class="col">
													<h6 class="m-b-5 text-white">Finished Projects</h6>
													<h3 class="m-b-0 text-white">6</h3>
												</div>
												<div class="col-auto">
